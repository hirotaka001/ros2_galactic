...
public:
        ...
        data_("Hello world!")
    {
        ...
        // decorationパラメータの宣言、lauchファイルでのパラメータ設定
        ...
        this->param_callback_handler_ = add_on_set_parameters_callback(parameter_callback);
    }
...
private:
    ...
    OnSetParametersCallbackHandle::SharedPtr param_callback_handler_;
    std::string data_;
